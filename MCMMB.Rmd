...
for (i in  1:length(bird_names)) {
  ...
  # saved plots separately in folder plots which are plotted afterwards, as alignment using par and other options didn't work
...
![**3.1.1: plot 1**](plots/Pachycephala_Lorentzi.png){width=45%} ![**3.1.2: plot 2**](plots/Pachycephala_Meyeri.png){width=45%}
![**3.1.2: plot 2**](plots/Pachycephala_schlegelii.png){width=45%} ![**3.1.2: plot 2**](plots/Pachycephala_simplex.png){width=45%}
![**3.1.2: plot 2**](plots/Pachycephala_soror.png){width=45%} 
...
```
![**3.1.1: plot 1**](plots/Pachycephala_Lorentzi_ensemble.png){width=45%} ![**3.1.2: plot 2**](plots/Pachycephala_Meyeri_ensemble.png){width=45%}
![**3.1.2: plot 2**](plots/Pachycephala_schlegelii_ensemble.png){width=45%} ![**3.1.2: plot 2**](plots/Pachycephala_simplex_ensemble.png){width=45%}
![**3.1.2: plot 2**](plots/Pachycephala_soror_ensemble.png){width=45%} 
