...
![**3.1.2: plot 2**](plots/Pachycephala_schlegelii.png){width=45%} ![**3.1.2: plot 2**](plots/Pachycephala_soror.png){width=45%} 
...
![**3.1.2: plot 2**](plots/Pachycephala_schlegelii_ensemble.png){width=45%} ![**3.1.2: plot 2**](plots/Pachycephala_soror_ensemble.png){width=45%} 

## 3.5. Comparison SDMs and IUCN

Plotting and comparing sdms with birdlife data.

```{r smd_plots, echo = FALSE, out.width = "150%"}
